...
#register new managed user 'sp2013_service' for service applications
$strPass = Read-Host -AsSecureString "Enter password for WebApp account"
$serviceAccountCredentials = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList "LAB\SP2013_Service", $strPass
...
-DatabaseName "SP2013_SecureStoreDB" -AuditlogMaxSize 30
